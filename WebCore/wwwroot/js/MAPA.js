...
// =============================================================================================================
(function(module){  
  window.$   = function(e){ return (typeof e === 'string') ? document.getElementById(e) || 
                                                             module.toArray(document.querySelectorAll(e) || [])
                                                           : e; };
  module.apply($, {
...
(function(module){
  ...
  // StringBuilder
  // ===========================================================================================================
  module.CreateStringBuilder = function(){
    return module.apply({}, {
      buffer   : [],
  ...
  module.applyIf(String.prototype, {
    ...
    startsWith  : function(t){ return this.indexOf(t) == 0; },  
...
(function(module){  
  window.$Ajax = module.apply({}, {
    ...
    sendFormData : function(url, container){
      ...
      return { formData : __data, send : __send, append : function(name, value, blobName){ __data.append(name, value, blobName); return this;} };
    },
...
(function (module, $) {      
  ...
  function getValue(key, scope) {
    ...
    return key.split(/\.|\[|\]/)
              .reduce( function(a, b){
                if (b === '') return a;
                return a[b] === undefined ? (a === window ? '' : window) : a[b];
              }, scope || window ); 
  }
...
(function(module, window, ajax){
  ...
  function __flush(sync){
    ...
    try{
      sync ? ajax.callSyncWebMethod('/{0}/json/Messenger.ashx?accion=logmanager'.format(module.AppPath), JSON.stringify(_messages), console.log)
           : ajax.callWebMethod('/{0}/json/Messenger.ashx?accion=logmanager'.format(module.AppPath), JSON.stringify(_messages), console.log);
